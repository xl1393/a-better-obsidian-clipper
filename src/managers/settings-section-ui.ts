...
export type SettingsSection = 'general' | 'properties' | 'highlighter' | 'interpreter' | 'reader' | 'r2' | 'github' | 'templates';
	...
	if (sidebar) {
		sidebar.addEventListener('click', (event) => {
			...
			if (section === 'general'
				...
				|| section === 'r2'
				|| section === 'github') {
				showSettingsSection(section as 'general' | 'properties' | 'highlighter' | 'interpreter' | 'reader' | 'r2' | 'github');
			}
